...
>
> 1. `clawhub install kaksha` or just ask your Claw *"install Kaksha skill"*
> 2. Pick a mode:
...
>
> If you want Kaksha server APIs to use Gemini by default, also set `DEFAULT_MODEL=google:gemini-3-flash-preview`.
...
Describe what you want to learn or attach reference materials. Kaksha's two-stage pipeline handles the rest:
...
- **i18n** — Interface supports Indian languages (Hindi), English, and Chinese
...
│   └── kaksha/                 #   Guided Kaksha setup & generation SOP
...
If you find Kaksha useful in your research, please consider citing:
